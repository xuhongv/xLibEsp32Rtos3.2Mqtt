...
static esp_err_t event_handler(void *ctx, system_event_t *event)
{
    ...
    case SYSTEM_EVENT_STA_GOT_IP:
    {
        ...
        {
            ret = xTaskCreate(TaskXMqttRecieve, "TaskXMqttRecieve", 1024 * 4, NULL, 8, NULL); // 创建任务
            vTaskDelay(500 / portTICK_RATE_MS);
            ret = xTaskCreate(TaskMainMqtt, "TaskMainMqtt", 1024 * 8, NULL, 10, &xHandlerMqtt);
        }
...
void app_main(void)
{
   ...
   xMQTT_CONFIG xMqttConfig =
        {
            .MQTTVersion = 4,
            .borkerHost = "193.112.51.78", //固定
            .borkerPort = 1883,            //固定
            .mqttCommandTimeout = 6000,
            .username = "admin",       //产品id
            .password = "xuhongv2019", //鉴权信息
